...
CREATE TABLE IF NOT EXISTS REVIEW_T(
	...
	CONSTRAINT USER_ID_RVW_FK FOREIGN KEY (USER_ID) REFERENCES USER_T(ID) ON DELETE CASCADE ON UPDATE CASCADE,
	CONSTRAINT FILM_ID_RVW_FK FOREIGN KEY (FILM_ID) REFERENCES FILM_T(ID) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS EVENTS_T(
    ...
    CONSTRAINT USER_ID_EVENTS_T_FK FOREIGN KEY (USER_ID) REFERENCES USER_T(ID) ON DELETE CASCADE ON UPDATE CASCADE
    );
